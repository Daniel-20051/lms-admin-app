...
interface TutorActionDialogsProps {
  selectedTutor: SoleTutor | null;
...
export default function TutorActionDialogs({
  selectedTutor,
  actionLoading,
  showApproveDialog,
  showRejectDialog,
  ...
  return (
    <>
      ...
      <AlertDialog open={showApproveDialog} onOpenChange={onApproveDialogChange}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Approve Sole Tutor</AlertDialogTitle>
            <AlertDialogDescription>
      ...
      <AlertDialog open={showRejectDialog} onOpenChange={(open) => {
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Reject Sole Tutor</AlertDialogTitle>
            <AlertDialogDescription>
      ...
      <AlertDialog open={showStatusDialog} onOpenChange={(open) => {
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Update Tutor Status</AlertDialogTitle>
            <AlertDialogDescription>
