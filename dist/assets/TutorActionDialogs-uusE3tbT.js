  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: showApproveDialog, onOpenChange: onApproveDialogChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Approve Sole Tutor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
          "Are you sure you want to approve this tutor? An email notification will be sent automatically.",
          selectedTutor && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 p-2 bg-muted rounded", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium", children: [
            "Tutor ID: ",
            selectedTutor.id
          ] }) })
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: showRejectDialog, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Reject Sole Tutor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
          "Please provide a reason for rejecting this tutor. An email notification will be sent automatically.",
          selectedTutor && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 p-2 bg-muted rounded", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium", children: [
            "Tutor ID: ",
            selectedTutor.id
          ] }) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            id: "reject-reason",
            placeholder: "e.g., Incomplete documentation, Missing qualifications...",
            value: rejectReason,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: showStatusDialog, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Update Tutor Status" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
          "Select the new status for this tutor.",
          selectedTutor && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 p-2 bg-muted rounded", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium", children: [
            "Tutor ID: ",
            selectedTutor.id
          ] }) })
...
export { TutorActionDialogs as default };
